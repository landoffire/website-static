...
BLOG_AUTHOR = "Land of Fire Team"  # (translatable)
BLOG_TITLE = "Land of Fire"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://landoffire.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://landoffire.org/"
BLOG_EMAIL = "pydsigner@gmail.com"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/", "Home"),
        #("http://forum.landoffire.org", "Forum"),
        ("/wiki/", "Wiki"),
        ("/gallery/", "Gallery"),
        ("https://discord.gg/AHsEpZB", "Discord"),
        ("/project/", "Project"),
        ("/team/", "Team"),
        ("/donate/", "Donate"),
    ),
...
PAGES = (
    ...
    ("galleries/*.rst", "", "gallery.tmpl"),
    ("galleries/*.md", "", "gallery.tmpl"),
    ("galleries/*.txt", "", "gallery.tmpl"),
    ("galleries/*.html", "", "gallery.tmpl"),
)
